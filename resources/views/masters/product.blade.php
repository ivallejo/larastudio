    ...
    <div class="card-body">
      ...
      <div class="row gx-3 mb-3" id="divNuevo" style="display: none">
        ...
        <div class="col-md-1">
            ...
            <input class="form-control" id="inputUnitPrice" type="number" placeholder="0.00" value="">
        </div>
        <div class="col-md-1">
          <label class="small mb-1" for="inputQuantity">Stock</label>
          <input class="form-control" id="inputQuantity" type="number" placeholder="0" value="">
        </div>
        
        <div class="col-md-2">
          <label class="small mb-1" for="inputPercentEmployee">Procentaje Empleado</label>
          <input class="form-control" id="inputPercentEmployee" type="number" placeholder="0.00" value="">
        </div>
      ...
      <input type="hidden" name="hddShowQuantity" id="hddShowQuantity" value="1">
        ...
        <table class="table table-reponsive table-bordered" id="dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              ...
              <th style="width:80px">Precio U. (S/.)</th>
